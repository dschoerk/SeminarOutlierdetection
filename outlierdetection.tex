...
For problems like outlier detection and clustering \cite{aggar2001} has shown that ... subspaces useful
...
\section{Feature Bagging} ensembles

\section{Subspace Outlier Detection}
